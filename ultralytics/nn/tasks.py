...
from ultralytics.nn.modules import (
    ...
    WorldDetect,
    v10Detect,
    ShuffleAttention, ResBlock_CBAM, CARAFE, ECAAttention, CoordAtt, BiLevelRoutingAttention, BiLevelRoutingAttention_nchw, EfficientAttention,
)
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            C3TR,
            C3Ghost,
            nn.ConvTranspose2d, ResBlock_CBAM, CARAFE, CoordAtt,
            DWConvTranspose2d,
            C3x,
            RepC3,
            PSA,
